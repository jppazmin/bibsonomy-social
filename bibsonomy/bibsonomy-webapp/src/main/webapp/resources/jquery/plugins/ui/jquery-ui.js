...
}a.extend(a.ui,{version:"1.8.8",keyCode:{ALT:18,BACKSPACE:8,CAPS_LOCK:20,COMMA:188,COMMAND:91,COMMAND_LEFT:91,COMMAND_RIGHT:93,CONTROL:17,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,INSERT:45,LEFT:37,MENU:93,NUMPAD_ADD:107,NUMPAD_DECIMAL:110,NUMPAD_DIVIDE:111,NUMPAD_ENTER:108,NUMPAD_MULTIPLY:106,NUMPAD_SUBTRACT:109,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SHIFT:16,SPACE:32,TAB:9,UP:38,WINDOWS:91}});
...
a.extend(a.ui.draggable,{version:"1.8.8"});
...
a.extend(a.ui.droppable,{version:"1.8.8"});
...
},_respectSize:function(l,g){var j=this.helper,i=this.options,r=this._aspectRatio||g.shiftKey,q=this.axis,u=a(l.width)&&i.maxWidth&&(i.maxWidth<l.width),m=a(l.height)&&i.maxHeight&&(i.maxHeight<l.height),h=a(l.width)&&i.minWidth&&(i.minWidth>l.width),s=a(l.height)&&i.minHeight&&(i.minHeight>l.height);
if(h){l.width=i.minWidth
}if(s){l.height=i.minHeight
}if(u){l.width=i.maxWidth
...
c.extend(c.ui.resizable,{version:"1.8.8"});
...
c.each(o,function(s,v){var u=(r[v]||0)+(k[v]||0);
if(u&&u>=0){p[v]=u||null
}});
...
if(/document/.test(g)||g==document){u.containerOffset={left:0,top:0};
...
u.containerSize={height:(n.innerHeight()-i[3]),width:(n.innerWidth()-i[1])};
...
u.parentData={element:k,left:q.left,top:q.top,width:h,height:s}
}},resize:function(g,q){var u=c(this).data("resizable"),i=u.options,f=u.containerSize,p=u.containerOffset,m=u.size,n=u.position,r=u._aspectRatio||g.shiftKey,e={top:0,left:0},h=u.containerElement;
if(h[0]!=document&&(/static/).test(h.css("position"))){e=p
}if(n.left<(u._helper?p.left:0)){u.size.width=u.size.width+(u._helper?(u.position.left-p.left):(u.position.left-e.left));
if(r){u.size.height=u.size.width/i.aspectRatio
...
if(r){u.size.width=u.size.height*i.aspectRatio
...
var l=Math.abs((u._helper?u.offset.left-e.left:(u.offset.left-e.left))+u.sizeDiff.width),s=Math.abs((u._helper?u.offset.top-e.top:(u.offset.top-p.top))+u.sizeDiff.height);
var k=u.containerElement.get(0)==u.element.parent().get(0),j=/relative|absolute/.test(u.containerElement.css("position"));
if(k&&j){l-=u.parentData.left
}if(l+u.size.width>=u.parentData.width){u.size.width=u.parentData.width-l;
if(r){u.size.height=u.size.width/u.aspectRatio
}}if(s+u.size.height>=u.parentData.height){u.size.height=u.parentData.height-s;
if(r){u.size.width=u.size.height*u.aspectRatio
...
a.extend(a.ui.selectable,{version:"1.8.8"})
})(jQuery);
...
a.extend(a.ui.sortable,{version:"1.8.8"})
})(jQuery);
...
p=null
}return this.queue("fx",function(){var v=h(this),r=v.attr("style")||" ",x=b(g.call(this)),u,s=v.attr("className");
h.each(f,function(y,z){if(m[z]){v[z+"Class"](m[z])
}});
u=b(g.call(this));
v.attr("className",s);
v.animate(i(x,u),n,p,function(){h.each(f,function(y,z){if(m[z]){v[z+"Class"](m[z])
}});
...
var q=h.queue(this),w=q.splice(q.length-1,1)[0];
q.splice(1,0,w);
h.dequeue(this)
})
};
...
h.extend(h.effects,{version:"1.8.8",save:function(n,o){for(var m=0;
m<o.length;
...
}h.fn.extend({effect:function(p,o,r,u){var n=d.apply(this,arguments),q={options:n[1],duration:n[2],callback:n[3]},s=q.options.mode,m=h.effects[p];
...
},easeInElastic:function(n,q,m,w,v){var r=1.70158;
var u=0;
var o=w;
if(q==0){return m
}if((q/=v)==1){return m+w
...
var r=u/4
}else{var r=u/(2*Math.PI)*Math.asin(w/o)
}return -(o*Math.pow(2,10*(q-=1))*Math.sin((q*v-r)*(2*Math.PI)/u))+m
},easeOutElastic:function(n,q,m,w,v){var r=1.70158;
var u=0;
var o=w;
if(q==0){return m
}if((q/=v)==1){return m+w
...
},easeInOutElastic:function(n,q,m,w,v){var r=1.70158;
var u=0;
var o=w;
if(q==0){return m
}if((q/=v/2)==2){return m+w
}if(!u){u=v*(0.3*1.5)
}if(o<Math.abs(w)){o=w;
var r=u/4
}else{var r=u/(2*Math.PI)*Math.asin(w/o)
}if(q<1){return -0.5*(o*Math.pow(2,10*(q-=1))*Math.sin((q*v-r)*(2*Math.PI)/u))+m
...
(function(a,b){a.effects.bounce=function(c){return this.queue(function(){var f=a(this),m=["position","top","bottom","left","right"];
...
(function(a,b){a.effects.shake=function(c){return this.queue(function(){var f=a(this),m=["position","top","bottom","left","right"];
var l=a.effects.setMode(f,c.options.mode||"effect");
...
a.extend(a.ui.accordion,{version:"1.8.8",animations:{slide:function(k,i){k=a.extend({easing:"swing",duration:300},k,i);
...
(function(a,b){a.widget("ui.autocomplete",{options:{appendTo:"body",delay:300,minLength:1,position:{my:"left top",at:"left bottom",collision:"none"},source:null},pending:0,_create:function(){var c=this,e=this.element[0].ownerDocument,d;
...
}if(c==="disabled"&&d&&this.xhr){this.xhr.abort()
...
(function($,undefined){$.extend($.ui,{datepicker:{version:"1.8.8"}});
...
d.extend(d.ui.dialog,{version:"1.8.8",uuid:0,maxZ:0,getTitleId:function(f){var g=f.attr("id");
if(!g){this.uuid+=1;
g=this.uuid
...
j.top+=n[1];
return this.each(function(){var s=f(this),v=s.outerWidth(),r=s.outerHeight(),u=parseInt(f.curCSS(this,"marginLeft",true))||0,q=parseInt(f.curCSS(this,"marginTop",true))||0,x=v+u+(parseInt(f.curCSS(this,"marginRight",true))||0),y=r+q+(parseInt(f.curCSS(this,"marginBottom",true))||0),w=f.extend({},j),p;
...
}s.offset(f.extend(w,{using:i.using}))
})
};
...
a.extend(a.ui.progressbar,{version:"1.8.8"})
})(jQuery);
...
d.extend(d.ui.tabs,{version:"1.8.8"});
